...
class SignUpAsAdminScreen extends StatelessWidget{
        ...
        child: Column(
          ...
          children: [
            commonButton(
              ...
              buttonName: "SignUp",
              onTap: (){
                // formValidationController.adminSignUpFormKey.currentState
                //     .save();
                // if (formValidationController.adminSignUpFormKey.currentState
                //     .validate()) {
          ...
          child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  commonText(title: "Sign Up As Admin!",color: blueColor,fontSize: 65.sp, fontWidget: FontWeight.bold),
                  SizedBox(
                    height: 200.h,
                  ),
                  Form(
                      key: formValidationController.adminSignUpFormKey,
